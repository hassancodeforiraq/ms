    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                            <li class="nav-item {{ Request::is('go') ? 'active' : '' }}">
                ...
                <ul class="navbar-nav ">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ Request::is('tickets','tickets/add') ? 'active' :  '' }}" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Tickets
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item {{ Request::is('tickets/add') ? 'active' :  '' }}" href="{{ route('tickets.add') }}">Add Ticket</a>
                            <a class="dropdown-item {{ Request::is('tickets') ? 'active' :  '' }}" href="{{ route('tickets') }}">Show Ticket</a>
                            </div>
                        </li>
                    </ul>
