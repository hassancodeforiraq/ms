...
class TicketController extends Controller
{
    ...
    {
        $tickets = Ticket::page()->paginate(10); // default 15 
        // $tickets = Ticket::page()->get();
        // $tickets = Ticket::page()->where('name','like','%' . request('search') . '%')
        // ->orWhere('age','like', '%' . request('search') . '%')
        // ->get();
        return view('tickets.index')->with('tickets',$tickets);
        // return view('tickets.index',['xxx',$tickets]); or this >> can use any name
        // return view('tickets.index',compact('tickets')); or this
        // get() VS all() : all() all col and get() can use many col or all EX:get(['name','age']);
        // orderBy('id','asc'); or desc EX:orderBy('id','asc')->get();
    }
    ...
    public function store(Request $request)
    {
      ...
      dd( $ticket);
       ...
       // dd( $request->all() );
        ...
        //or
        // return redirect()->back()->with('success','Yes You Do It');
